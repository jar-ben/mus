...
//	std::vector<std::vector<int>> clauses;
	...
	std::vector<bool> shrink_muser(std::string input, int hash);
	std::vector<bool> shrink_dmuser(std::string input, int hash);
	std::vector<bool> shrink_mcsmus(std::string input, int hash);
